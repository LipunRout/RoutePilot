...
const sendRoadmapEmail = async ({ to, userName, role, pdfBuffer }) => {
  await transporter.sendMail({
    ...
    to,
    subject: `Your ${role} Roadmap is ready — RoutePilot`,
    html: `
      <div style="font-family:Arial,sans-serif;background:#0a0f14;color:#e2e8f0;max-width:560px;margin:0 auto">
        ...
        <div style="padding:32px 40px">
          <div style="font-size:15px;color:#94a3b8;margin-bottom:16px">Hey ${userName} 👋</div>
        ...
        <div style="padding:0 40px 28px;font-size:11px;color:#334155;text-align:center">
          © ${new Date().getFullYear()} RoutePilot · <a href="${process.env.FRONTEND_URL}" style="color:#00c97a">routepilot.app</a>
        </div>
      </div>
    `,
    attachments: [{
