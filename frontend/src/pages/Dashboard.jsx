...
const ACHIEVEMENTS = [
  ...
  { icon: '✦',  label: 'Phase master',     earned: true  },
  { icon: '📚', label: '50 hours logged',  earned: true  },
  { icon: '🚀', label: 'Roadmap complete', earned: true  },
...
const UPDATES = [
  { icon: '✦', text: 'Completed Phase 3 of Frontend Developer', time: '2h ago',  color: '#00c97a' },
  { icon: '📖', text: 'Started "React Ecosystem" module',        time: '2h ago',  color: '#0ea5e9' },
  { icon: '🔥', text: 'Reached a 12-day learning streak!',       time: '1d ago',  color: '#f59e0b' },
  { icon: '✉', text: 'Roadmap PDF sent to your email',           time: '3d ago',  color: '#a855f7' },
  { icon: '⚡', text: 'Earned "Phase Master" achievement',        time: '5d ago',  color: '#00c97a' },
]
  ...
  return (
    <>
      <style>{`
        ...
        .db-roadmap-card:hover {
          border-color: var(--border-hover);
          transform: translateY(-2px);
          box-shadow: 0 8px 24px rgba(0,0,0,0.2);
        }

        .db-roadmap-card-glow {
          position: absolute; inset: 0;
          border-radius: 12px;
          opacity: 0;
        ...
        .db-xp-card {
          ...
          border-radius: 14px;
          padding: 24px;
          animation: dbFade 0.5s ease 0.2s both;
        }
        ...
        .db-rfc-pct {
          ...
          color: var(--text-2); min-width: 32px;
        }
        ...
        .db-rfc-btn-secondary {
          background: var(--bg-2);
          border: 1px solid var(--border);
          color: var(--text-2);
        }

        .db-rfc-btn-secondary:hover {
          background: var(--bg-3);
          color: var(--text-1);
        }
        ...
        .db-new-roadmap {
          ...
          text-decoration: none;
          display: block;
          animation: dbFade 0.4s ease 0.3s both;
        }

        .db-new-roadmap:hover {
              ...
              <div className="db-col-left">
                ...
                <div className="db-card" style={{ animationDelay: '0s' }}>
                  <div className="db-card-title">
                    Active Roadmaps
                    <Link to="#" className="db-card-link" onClick={() => setTab('roadmaps')}>
                      View all →
                    </Link>
                  </div>
                    ...
                    {ROADMAPS.map((rm, i) => (
                      ...
                      >
                        <div
                          ...
                          style={{ background: `radial-gradient(ellipse 60% 60% at 20% 50%, ${rm.glow}, transparent)` }}
                        />
                  ...
                  <div className="db-chart">
                    {ACTIVITY.map((a, i) => (
                      <div className="db-chart-col" key={a.day}>
                        <div className="db-chart-bar-wrap">
                          <div
                            ...
                            style={{
                              ...
                              background: a.hrs === maxHrs
                                ? 'linear-gradient(180deg, #00c97a, #00c97a88)'
                        ...
                        <span className="db-chart-day">{a.day}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="db-xp-card">
                  ...
                  <div className="db-xp-top">
                    <div>
                      ...
                      <div className="db-xp-label">Level 7 — Navigator</div>
                    </div>
                    <div className="db-xp-next">Next: 4000 XP</div>
                  </div>
                  <div className="db-xp-bar">
                    <div
                      className="db-xp-fill"
                      style={{ width: `${(USER.xp / 4000) * 100}%` }}
                    />
                  </div>
                ...
                <div className="db-card" style={{ animationDelay: '0.2s' }}>
                  ...
                  <div className="db-quick">
                    {[
                      ...
                      { icon: '◈', title: 'Continue',       desc: 'Pick up where left', to: '/roadmap' },
            ...
            <div className="db-roadmaps-tab">
                ...
                >
                  ...
                  <div className="db-rfc-info">
                    ...
                    <div className="db-rfc-progress-row">
                      ...
                      <span className="db-rfc-pct" style={{ color: rm.color }}>
                        {rm.progress}%
                      </span>
                      <span className={`db-rc-status ${rm.status}`}>
                        {rm.status === 'active' ? '● Active' : rm.status === 'paused' ? '⏸ Paused' : '✓ Done'}
                  ...
                  <div className="db-rfc-right">
                    <div className="db-rfc-actions">
                      <Link to="/roadmap" className="db-rfc-btn db-rfc-btn-primary">
                        {rm.status === 'completed' ? 'Review' : 'Continue →'}
                      </Link>
                      <button className="db-rfc-btn db-rfc-btn-secondary">
                        ✉ PDF
                      </button>
                    </div>
                    <div style={{
              ...
              <Link to="/category" className="db-new-roadmap">
                ...
                <div className="db-new-roadmap-sub">
                  Explore 33+ career paths across IT, Non-IT, Government & Business
                </div>
              </Link>
            </div>
          )}
                ...
                <div className="db-chart" style={{ height: 120 }}>
                  {ACTIVITY.map((a, i) => (
                    <div className="db-chart-col" key={a.day}>
                      ...
                      <span className="db-chart-day">{a.day} · {a.hrs}h</span>
                    </div>
                  ))}
                </div>
              </div>
